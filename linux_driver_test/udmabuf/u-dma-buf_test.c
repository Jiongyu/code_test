...
#define TEST_DMA_BUF_LEN (1*1024*1024)
static char testBuf[TEST_DMA_BUF_LEN];
...
void jony_check_buf_test(unsigned int size, unsigned int sync_mode, int o_sync)
{
    int            fd;
    unsigned char  attr[1024];
    struct timeval start_time, end_time;
...
void main()
{
    ...
    memset(&testBuf, 0, TEST_DMA_BUF_LEN);
    memset(&testBuf, 'a', TEST_DMA_BUF_LEN - 1);
    printf("check_buf()\n", buf_size);
    jony_check_buf_test(buf_size, 0, 0);
    jony_check_buf_test(buf_size, 0, O_SYNC);
    jony_check_buf_test(buf_size, 1, 0);
    jony_check_buf_test(buf_size, 1, O_SYNC);
    jony_check_buf_test(buf_size, 2, 0);
    jony_check_buf_test(buf_size, 2, O_SYNC);
    jony_check_buf_test(buf_size, 3, 0);
    jony_check_buf_test(buf_size, 3, O_SYNC);
    jony_check_buf_test(buf_size, 4, 0);
    jony_check_buf_test(buf_size, 4, O_SYNC);
    jony_check_buf_test(buf_size, 5, 0);
    jony_check_buf_test(buf_size, 5, O_SYNC);
    jony_check_buf_test(buf_size, 6, 0);
    jony_check_buf_test(buf_size, 6, O_SYNC);
    jony_check_buf_test(buf_size, 7, 0);
    jony_check_buf_test(buf_size, 7, O_SYNC);
}
